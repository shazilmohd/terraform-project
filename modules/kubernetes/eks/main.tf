...
# Attach the AWS managed policy for EKS cluster
resource "aws_iam_role_policy_attachment" "eks_cluster_policy" {
  policy_arn = "arn:aws:iam::aws:policy/AmazonEKSClusterPolicy"
  role       = aws_iam_role.eks_cluster_role.name
}

# Attach the VPC Resource Controller policy (required for EKS)
...
# ============================================================================
# IAM Role for EKS Node Group (Worker Node Role)
# ============================================================================
...
resource "aws_eks_cluster" "main" {
  ...
  vpc_config {
    ...
    security_groups         = length(var.cluster_security_group_ids) > 0 ? var.cluster_security_group_ids : null
...
resource "aws_eks_node_group" "main" {
  ...
  # Security groups
  security_groups = length(var.node_security_group_ids) > 0 ? var.node_security_group_ids : null
...
# ============================================================================
# EKS Add-ons (Minimal - only required add-ons)
# ============================================================================

# VPC CNI Plugin (required for networking)
...
# Attach VPC CNI policy to the role
